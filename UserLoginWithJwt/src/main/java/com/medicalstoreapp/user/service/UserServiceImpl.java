...
public class UserServiceImpl implements IUserService {
	...
	public ReportDetails findReportDetailsById(Long reportId) {
		...
		return restTemplate.getForObject(reportBaseUrl+"/reports/byreportid/"+reportId, ReportDetails.class);
	}
	/**
	 * Deleting report by its id
	 */
	@Override
	public String deleteReportById(Long reportId) {
		restTemplate.delete(reportBaseUrl+"/reports/delete/byreportid/"+reportId);
	...
	public List<ReportDetails> findAllReports() {
		...
		return Arrays.asList(restTemplate.getForObject(reportBaseUrl+"/reports/all", ReportDetails[].class));
	}

	/**
	 * Getting all the reports by its type
	 */
	@Override
	public List<ReportDetails> findAllReportsByReportType(String reportType) {
		
		return Arrays.asList(restTemplate.getForObject(reportBaseUrl+"/reports/byreporttype/"+reportType, ReportDetails[].class));
	}

	/**
	 * Getting all report details in a period
	 */
	@Override
	public ReportDetails findReportByPeriod(String startDate, String endDate) {
		
		return restTemplate.getForObject(reportBaseUrl+"/reports/byperiod/"+startDate+"/"+endDate, ReportDetails.class);
